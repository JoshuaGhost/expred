...
from rationale_benchmark.models.pipeline.pipeline_utils import SentenceEvidence, _grouper, \
    score_rationales
from rationale_benchmark.utils import Annotation
from eraser_benchmark import rational_bits_to_ev_generator
...
def decode(evidence_identifier: nn.Module,
    ...
    def prep(data: List[Annotation]) -> List[Tuple[SentenceEvidence, SentenceEvidence]]:
        ...
        from rationale_benchmark.models.pipeline.mtl_token_identifier import chain_sentence_evidences
