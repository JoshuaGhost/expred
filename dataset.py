...
class Dataset():
    def __init__(self, config):
        ...
        self.docids = set(chain.from_iterable(extract_doc_ids_from_annotations(d)
    ...
    def preprocess(self, tokenizer):
        ...
        def preprocess_wrapper():
            ...
            for split in 'train val test'.split():
                ...
                ret.append(preprocess(data, self.config, tokenizer))
                #self.docs, self.label_list,
        ...
        self.train_input_ids, self.train_input_masks, self.train_segment_ids, \
                                        self.train_rations, self.train_labels = self.rets_train
